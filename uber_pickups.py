...
rows_data = st.slider('Combien de data voulez-vous voir?', 1000, 20000)
...
st.write(data[data['lat'] >= latitude_filter])
st.map(data[data['lat'] >= latitude_filter])